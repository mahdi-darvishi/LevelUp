...
const Contact = () => {
  return (
    <div className="font-poppins">
      ...
      <div className="max-w-screen overflow-x-hidden  h-screen sm:mb-[-10%]">
      ...
      <section className="bg-indigo-400/60 ">
        <div className="py-8 px-4  mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto mt-12 max-w-screen-md sm:text-center">
            <h2 className="mb-4 mt-6 text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl ">
              Sign up for our newsletter
            </h2>
            <p className="mx-auto mb-8 max-w-2xl  text-gray-800 md:mb-12 sm:text-xl ">
            ...
            <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                <div className="relative w-full">
                  ...
                  <input
                    className="block p-3 pl-10 w-full text-sm text-gray-900 bg-blue-200/80 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg placeholder-black  "
