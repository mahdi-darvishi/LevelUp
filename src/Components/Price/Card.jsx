  ...
  return (
    ...
    >
      ...
      <div className="text-center font-medium">
        ...
        <p className="py-2 border-b mx-8 flex justify-between text-xs lg:text-base">
          {Feature3}
      ...
      <button
        className={`justify-center flex mx-auto w-[200px] ${btnBg} ${hoverBgBtn} ${btnTextColor} rounded-md font-medium my-6 py-3`}
      >
        Contact Support
      </button>
    </div>
