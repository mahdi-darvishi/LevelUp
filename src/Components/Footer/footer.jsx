    ...
    <div className="overflow-x-hidden max-w-screen font-poppins">
      ...
      <div className="sm:flex justify-between py-10 px-8 grid bg-gray-900">
        <div className="text-white">
          ...
          <p className="py-4">
            ...
            skilled analysts, we specialize in deciphering complex ddata sets to
            uncoer valuable patterns and trends with which wee take your
      ...
      <div className="sm:mx-auto pt-10 pb-8 sm:grid flex-row lg:grid-cols-3 w-screen gap-8 text-gray-300 bg-gray-800">
        ...
        <p className="pt-4 text-gray-200/40 text-sm flex justify-center text-center">
          All Rigths Reserved 2023 - LevelUp Solutions
        </p>
      </div>
