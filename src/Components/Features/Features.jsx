                ...
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                  <div>
                    ...
                    <p className="mt-3 text-lg ">
                      ...
                      technologies, and receiving personalized support. logo1
                      Advanced Algorithm
                    </p>
                  ...
                  <div aria-hidden="true" className="mt-10 lg:mt-0">
                    <img
                      src={Image1}
                      alt="image1"
                      className="taos:translate-x-[200px] taos:opacity-0 hover:-translate-y-2 transition ease-in-out duration-300 hover:drop-shadow-xl mx-auto rounded-lg shadow-lg "
                    />
                  </div>
                </div>
                <div>
                  <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                      <img
                        src={Image2}
                        alt="image2"
                        className="taos:translate-x-[200px] taos:opacity-0 hover:-translate-y-2 transition ease-in-out duration-300 hover:drop-shadow-xlmx-auto rounded-lg shadow-lg "
                      />
                    </div>
                  </div>
                </div>
