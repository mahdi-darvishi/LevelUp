      ...
      <nav className="bg-gray-900 fixed px-2 sm:h-auto sm:w-full w-screen z-20 left-0 right-0 top-0 border-b border-gray-400">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto sm:p-4 pb-2">
          <Link to="/" className="flex items-center">
            <img
              src={Icon}
              alt="icon"
              className="hidden  sm:block sm:w-[35px] sm:h-[35px] ml-4"
            />
          ...
          <div className="flex">
            <ul className="sm:flex justify-center gap-x-4 hidden">
              <li className="p-4 text-white hover:text-blue-400 cursor-pointer">
                <Link to="/">Home</Link>
              </li>
              {/* <li className="p-4 text-white hover:text-blue-400 cursor-pointer">
        ...
        <div className={`${open ? null : "hidden"} h-[19rem]`}>
          ...
          <div className="bg-gray-200/50 h-[1px] w-[85%]  ml-[-10px] ">
            ...
            <p className="my-auto ml-[103px] mt-[-27px] text-gray-200/60 text-xs font-light  ">
              SamSmith@email.com
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <p className="mt-[25px] text-gray-100/30 text-sm">
              All Rigths Reserved - LeelUP Solutions
            </p>
          </div>
        </div>
      </nav>
